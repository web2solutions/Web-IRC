...
There are some external dependencies that need installation before usage.
	...
	cpanm POE IRC::Utils Crypt::PasswdMD5 POE::Filter::IRCD Net::Netmask POE::Component::Syndicator DDP SQL::Abstract Redis POE::Component::Client::Ident::Agent POE::Component::Client::DNS DateTime::Precise
Redis
